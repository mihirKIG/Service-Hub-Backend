"""
Django settings for servicehub_backend project.
"""
...
ROOT_URLCONF = 'servicehub_backend.urls'
...
WSGI_APPLICATION = 'servicehub_backend.wsgi.application'
ASGI_APPLICATION = 'servicehub_backend.asgi.application'
